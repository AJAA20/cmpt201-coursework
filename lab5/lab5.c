...
// 1. Loop over all of the items in free list starting from head:
// - calculate ptr addr adjacent to the left
// - calculate the ptr addr adjacent to the right
// if (recently freed block is adjacent to the left)
//     increase the size of the recently freed block
//     adjust the next pionter of therecently freed block
//     remove curr block from the list
// if (recently freed block is adjacent to the right)
